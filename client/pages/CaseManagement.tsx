...
export default function CaseManagement() {
  ...
  const [selectedCase, setSelectedCase] = useState<CaseWithDetails | null>(
    null,
  );
  ...
  useEffect(() => {
    ...
    if (statusFilter !== "all") {
      filtered = filtered.filter(
        (case_) => case_.current_status === statusFilter,
      );
    }

    if (operationFilter !== "all") {
      filtered = filtered.filter(
        (case_) => case_.operation_type === operationFilter,
      );
    }
            ...
            <form onSubmit={handleNewCaseSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={newCaseForm.operation_type}
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="بانتظار المستندات">
                  بانتظار المستندات
                </SelectItem>
                <SelectItem value="تم التقديم للجمارك">
                  تم التقديم للجمارك
                </SelectItem>
                <SelectItem value="بانتظار الفحص والمعاينة">
                  بانتظار الفحص
                </SelectItem>
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center space-x-2 space-x-reverse">
                        ...
                        <Badge variant="outline">
                          {caseItem.operation_type === "import"
                            ? "استيراد"
                            : "تصدير"}
                        </Badge>
                      </div>
                      ...
                      <p className="text-sm text-gray-600">
                        العميل: {caseItem.client_name} • الميناء:{" "}
                        {caseItem.port}
                      </p>
        ...
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          {selectedCase && (
            <>
              <DialogHeader>
                <DialogTitle>
                  تفاصيل الملف {selectedCase.case_number}
                </DialogTitle>
                <DialogDescription>
                      ...
                      <div className="flex items-center space-x-2 space-x-reverse">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {selectedCase.operation_type === "import"
                              ? "استيراد"
                              : "تصدير"}
                          </p>
                        </div>
