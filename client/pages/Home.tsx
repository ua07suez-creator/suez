...
const Home = () => {
  ...
  const services = [
    {
      ...
      description:
        "خدمات تخليص جمركي شاملة للشحن البحري عبر جميع الموانئ المصرية",
  ...
  const advantages = [
    ...
    },
    {
      ...
      title: "خبرة محلية",
      description:
        "معرفة عميقة بالقوانين المصرية وعلاقات ممتازة مع الجهات الجمركية",
    },
    {
      icon: MessageCircle,
      title: "دعم 24/7",
  ...
  const testimonials = [
    {
      ...
      content:
        "خدمة ممتازة وسرعة في الإنجاز. تم تخليص شحنتنا في وقت قياسي مع أسعار منافسة.",
      rating: 5,
    },
    {
      name: "��اطمة علي",
      ...
      content:
        "فريق محترف وخبرة واسعة. نتعامل معهم منذ سنوات ولم نواجه أي مشاكل.",
      rating: 5,
    },
    {
      name: "أحمد حسن",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-200 leading-relaxed">
                نقدم خدمات تخليص جمركي متميزة مع ضمان السرعة والدقة والشفافية
                الكاملة. فريق من الخبراء المعتمدين لخدمة جميع احتياجاتكم
                الجمركية.
              </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className="card-custom group hover:shadow-lg transition-all duration-300"
                >
                  ...
                  <ul className="space-y-2 mb-6">
                    {service.features.map((feature, idx) => (
                      <li
                        key={idx}
                        className="flex items-center space-x-2 space-x-reverse text-sm text-gray-text"
                      >
      ...
      <section className="bg-gray-card section-spacing">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-text max-w-3xl mx-auto">
              نتميز بالخبرة والكفاءة والالتزام بأعلى معايير الجودة في خدمات
              التخليص الجمركي
            </p>
          </div>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              شهادات حقيقية من عملائنا الذين وثقوا بنا لتقديم خدمات التخليص
              الجمركي
            </p>
          </div>
        ...
        <div className="container-custom">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-text">
              نعمل مع أفضل المؤسسات والجهات الحكومية
            </p>
          </div>
      ...
      <section className="bg-navy-dark text-white section-spacing">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto">
            احصل على استشارة مجانية وعرض سعر مخصص لاحتياجاتك. فريقنا جاهز
            لخدمتكم على مدار الساعة.
          </p>
