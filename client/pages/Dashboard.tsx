    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>آخر 3 ملفات تم تحديثها</CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  <div className="flex items-center space-x-3 space-x-reverse">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {getOperationTypeLabel(caseItem.operation_type)} -{" "}
                        {caseItem.port}
                      </p>
                    </div>
                  </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {client && (
              <div>
                ...
                <div className="space-y-1 text-sm text-gray-600">
                  {client.company_name && (
                    <p>اسم الشركة: {client.company_name}</p>
                  )}
                  <p>
                    نوع النشاط:{" "}
                    {client.company_type === "company" ? "شركة" : "فردي"}
                  </p>
                  {client.city && <p>المدينة: {client.city}</p>}
                  {client.tax_number && (
                    <p>الرقم الضريبي: {client.tax_number}</p>
                  )}
                </div>
              </div>
            )}
          ...
          <div className="mt-4">
            <Button variant="outline">تحديث البيانات</Button>
          </div>
        </CardContent>
      </Card>
    </div>
