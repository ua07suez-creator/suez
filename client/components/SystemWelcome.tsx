      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-text max-w-2xl mx-auto">
            نظام متكامل لإدارة عمليات التخليص الجمركي مع واجهات متقدمة للعملاء
            والإدارة
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          ...
          <Link to="/register">
            <Button
              variant="outline"
              className="btn-navy-outline text-lg px-8 py-4"
            >
              إنشاء حساب جديد
            </Button>
          </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="card-custom hover:shadow-lg transition-shadow"
              >
        ...
        <Card className="bg-navy-light text-white">
          <CardContent className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-4">نظام شامل ومتكامل</h3>
              ...
              <div className="text-center">
                ...
                <Link to="/login">
                  <Button
                    variant="secondary"
                    className="bg-white text-navy-light hover:bg-gray-100"
                  >
                    دخول النظام
                  </Button>
                </Link>
